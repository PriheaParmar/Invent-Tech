...
def utilities_view(request):
    # Utilities live inside the dashboard template as a section.
    # Redirect to dashboard with a hash so the correct section opens.
    return redirect(reverse("accounts:dashboard") + "#utilities")
...
def party_create(request):
    ...
    tpl = "accounts/parties/form_embed.html" if _is_embed(request) else "accounts/parties/form_page.html"
